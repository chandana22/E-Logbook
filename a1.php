...
if(isset($_SESSION['subj']) && (!isset($_POST["subj"]))){
if(isset($_POST['sub'])){
$_SESSION['subj']=$_POST['sub'];
}
 ...
 unset($_SESSION['Session.Error']); } ?>
				  ...
				  <div class="ui three fields">
					...
					<div class="field">
						...
						<div class="ui selection dropdown">
							<input name="sub" type="hidden" id='location'>
							<div class="default text">	<?php
  ...
  <div class="field">
      ...
      <div class="ui fluid selection dropdown">
        ...
        <div class="menu">
		<?php
								$qry= "SELECT * FROM Session WHERE sub='$subj' ";
								$result=mysqli_query($con,$qry);
								while ($row=mysqli_fetch_array($result))
								{	echo "<div class='item' data-value='";
									echo $row['batch'];
