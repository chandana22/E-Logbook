...
<div class="ui basic modal" id="each_student">
	...
	<?php
							...
							$qry= "SELECT * FROM logbook_final where usn='$usn' and sub_name='$sub'";
							...
							if(mysqli_num_rows($result) <= 0) {
								...
								echo " <table class='ui left aligned inverted five column celled table segment'><thead><tr><th>USN</th><th>Subject</th><th>Sid</th><th>Log in</th><th>System_no</th></tr></thead><tbody>";
								...
								echo "</tbody></table>";
								$q="SELECT count(*) as total FROM logbook_final where usn='$usn' and sub_name='$sub'";
							$result=mysqli_query($con,$q);
							$data=mysqli_fetch_assoc($result);
							echo "Total number of classes attended:  ";
							echo $data['total'];
							echo "<br />";
							$q="SELECT count(*) as total FROM logbook_final where sub_name='$sub'";
							$result=mysqli_query($con,$q);
							$data=mysqli_fetch_assoc($result);
							echo "Total number of classes held:  ";
							echo $data['total'];
							}
