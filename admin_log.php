  ...
  <div class="ui inverted page grid masthead segment" style="padding-top:30px;background-image:url(images/4.jpg)">
    <div class="column">
      ...
      <div class="ui hidden transition information">
        ...
        <p>Log in as Admin to host a lab session, modify student details and to generate reports</p>
		<br />
    ...
    <div class="twelve center aligned wide column">
      ...
      <div class="ui two column center aligned stackable divided grid" >
        ...
        <div class="column">
			...
			<img src="images/admin4.jpg" class="circular medium ui image" >
		</div> 
...
<form class="ui inverted black secondary form segment" name="input" action="admin_login.php" method="post">
<?php if(isset($_SESSION['Login.Error']))  {  echo "<div class='ui inverted red segment'>"; echo $_SESSION['Login.Error']; echo "</div>";
 unset($_SESSION['Login.Error']); } ?>
  <div class="field">
    <label>Username</label>
    <div class="ui left teal labeled icon input">
  ...
  <div class="field">
    ...
    <div class="ui left labeled teal icon input">
  ...
  <div class="teal ui submit button">Login</div>
