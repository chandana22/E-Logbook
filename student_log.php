...
<form class="ui inverted black secondary form segment" name="input" action="student_login.php" method="post">
 ...
 unset($_SESSION['Login.Error']); } ?>
  <div class="field">
    ...
    <div class="ui left red labeled icon input">
      <input placeholder="Username" type="text" name="USN">
  ...
  <div class="red ui submit button">Login</div>
