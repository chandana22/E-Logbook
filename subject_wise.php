...
<div class="ui basic modal" id="each_student">
	...
	<?php
							...
							$sub=$_POST['subject'];
							$qry= "SELECT * FROM logbook_final where sub_name='$sub'";
							...
							if(mysqli_num_rows($result) <= 0) {
								...
								{	echo "<tr><td>";
									...
									$sid=$row['sid'];
									$q="SELECT count(*) as total from logbook_final where sid='$sid'";
							...
							$r=mysqli_query($con,$q);
							echo " Total number of classes held for this subject : ";
							$data=mysqli_fetch_assoc($r);
							echo $data['total'];
						}	
