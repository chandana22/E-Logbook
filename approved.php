            ...
            <div class="column">
				...
				<?php if(isset($_SESSION['Approval_Status']))
					{	echo "<p class='ui green leaf image'>";
						...
						echo "<table class='ui left aligned table segment'><thead><tr><th>Sid</th><th>Status</th><th>Subject</th><th>Batch</th><th>Status</th></tr></thead><tbody><tr class='positive'><td>";
						echo $_SESSION['sid'];
						echo "</td><td><i class='icon checkmark'></i> Inactivated </td><td>";
						echo $_SESSION['subj'];
						echo "</td><td>";
						echo $_SESSION['batch'];
						echo "</td><td><i class='icon checkmark'></i> Approved </td><td></tr></tbody></table>";
...
<a href='approvee.php'> <div class="teal centre aligned ui button" >Approve other sessions</div></a>
</div>
  </div>
		</div>
