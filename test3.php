...
<body >
  ...
  <div class="ui page center aligned grid overview segment">
		...
		<div class="ui tabular fluid inverted filter menu">
		 ...
		 <div class="ui divided inbox selection list active tab" data-tab="student">
		     <div class="ui  raised red segment">
    		   <div class="column">
				<form class="ui secondary form segment"  action="each_student.php" method="post">
					<div class="ui buttons">
					<div class="ui vertical teal animated large button" id="b1">
				...
				<div class="or"></div>
					<div class="ui vertical teal large animated  button" id="b2">
    ...
    <div class="content">
      ...
      <div class="right">
        <p>Enter USN of the student you are looking for</p>
		<div class='field'><input placeholder="Username" type="text" name="USN"></div>
      </div>
    </div>
    <div class="actions">
	...
	<div class="left">
	  ...
	  <div class="right">
        <p>Enter the USN of the student you want to search</p>
      </div>
	 </div>
		...
		<input placeholder="Search..." type="text" name="USN">
  ...
  <div class="ui basic users modal">
    <div class="header">
		Commit Session 
    </div>
    <div class="content">
