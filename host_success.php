				...
				<div class="ui teal raised center aligned segment">
					<?php
						$con=mysqli_connect("localhost", "root", "","Elogbook")or die("cannot connect");
							...
							echo "<table class='ui left aligned table segment'><thead><tr><th>Sid</th><th>Status</th><th>Subject</th><th>Batch</th><th>Experiment_no</th><th>Status</th></tr></thead><tbody><tr class='positive'><td>";
						echo $sid;
...
<a href='host_session.php'> <div class="teal centre aligned ui button" >Host other sessions</div></a>
</div>
