...
<div class="ui negative disable button">Disable</div>
					<?php
						$con=mysqli_connect("localhost", "root", "","Elogbook")or die("cannot connect");
							...
							$qry= "SELECT * FROM logbook_temp left join student on logbook_temp.USN=student.USN where student.batch='$batch' and sub_name='$subj' ";
							...
							if(mysqli_num_rows($result) <= 0) {
								...
								$v=0;
								echo " <table class='ui  left aligned inverted table segment'><thead><tr><th>Session_id</th><th>Subject</th><th>USN</th><th>Name</th><th>Batch</th><th>Timestamp</th><th>system_no</th><th>approve</th></tr></thead><tbody>";
								...
								{	
									echo "<tr><td>";
										...
										echo "</td><td>";
										echo	"<div class='field'><div class='ui toggle checkbox'><input name='app[]' type='checkbox' checked='checked' value='";
										echo $row['USN'];
										echo "'><div class='box';></div></div>";
										echo "</td></tr>";
